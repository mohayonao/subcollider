...
describe("sc.number", () => {
  ...
  describe("bilinrand(x)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.bilinrand(1), -0.3885699191596, 1e-6));
      assert(closeTo(sc.bilinrand(1), -0.1414964245632, 1e-6));
      assert(closeTo(sc.bilinrand(1), -0.5384126210119, 1e-6));
      assert(closeTo(sc.bilinrand(1), -0.5565782326739, 1e-6));
      assert(closeTo(sc.bilinrand(9), -7.2654132130556, 1e-6));
      assert(closeTo(sc.bilinrand(9), +0.8119932613335, 1e-6));
      assert(closeTo(sc.bilinrand(9), +7.0138743314892, 1e-6));
      assert(closeTo(sc.bilinrand(9), +0.5420275074429, 1e-6));
  ...
  describe("coin(x)", () => {
    it("works", () => {
      ...
      assert(sc.coin(0.5) === true);
      assert(sc.coin(0.5) === false);
      assert(sc.coin(0.5) === true);
      assert(sc.coin(0.5) === true);

      let randomAPI = randSeed([ 0.1, 0.6, 0.7, 0.4, 0.8 ]);

      assert(sc.coin(0.6, randomAPI) === true);
      assert(sc.coin(0.6, randomAPI) === false);
      assert(sc.coin(0.6, randomAPI) === false);
      assert(sc.coin(0.6, randomAPI) === true);
    });
  });
  ...
  describe("exprand(a, b)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.exprand(1, 10), 2.334622838603, 1e-6));
      assert(closeTo(sc.exprand(1, 10), 5.711979615374, 1e-6));
      assert(closeTo(sc.exprand(1, 10), 1.208316367513, 1e-6));
      assert(closeTo(sc.exprand(1, 10), 1.673697945091, 1e-6));
      assert(closeTo(sc.exprand(9, 99), 12.47477185492, 1e-6));
      assert(closeTo(sc.exprand(9, 99), 45.36611369748, 1e-6));
      assert(closeTo(sc.exprand(9, 99), 13.94434353425, 1e-6));
      assert(closeTo(sc.exprand(9, 99), 52.96812183028, 1e-6));
  ...
  describe("gauss(x, standardDeviation)", () => {
    it("works", () => {
      config.randSeed(12345);

      assert(closeTo(sc.gauss(1, 0.5), 0.2938596756331, 1e-6));
      assert(closeTo(sc.gauss(1, 0.5), 2.1025203645272, 1e-6));
      assert(closeTo(sc.gauss(1, 0.5), 0.1115754066203, 1e-6));
      assert(closeTo(sc.gauss(1, 0.5), 0.0800493010739, 1e-6));
      assert(closeTo(sc.gauss(9, 0.1), 8.6746454461307, 1e-6));
      assert(closeTo(sc.gauss(9, 0.1), 8.9345785035090, 1e-6));
      assert(closeTo(sc.gauss(9, 0.1), 9.0308411457271, 1e-6));
      assert(closeTo(sc.gauss(9, 0.1), 9.1451403343025, 1e-6));
    });
  });
  describe("gaussCurve(x, a = 1, b = 0, c = 1)", () => {
    it("works", () => {
      assert(closeTo(sc.gaussCurve(1), 0.60653065971263, 1e-6));
      assert(closeTo(sc.gaussCurve(1, 9), 5.4587759374137, 1e-6));
      assert(closeTo(sc.gaussCurve(1, 9, 5), 0.0030191636511226, 1e-6));
      assert(closeTo(sc.gaussCurve(1, 9, 5, 2), 1.2180175491295, 1e-6));
    });
  });
  describe("hypot(x, y)", () => {
    it("works", () => {
  ...
  describe("linrand(x)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.linrand(1), 0.3682167297229, 1e-6));
      assert(closeTo(sc.linrand(1), 0.0821806583553, 1e-6));
      assert(closeTo(sc.linrand(1), 0.1361543098464, 1e-6));
      assert(closeTo(sc.linrand(1), 0.1825973687227, 1e-6));
      assert(closeTo(sc.linrand(9), 0.0200419498141, 1e-6));
      assert(closeTo(sc.linrand(9), 6.2576153576374, 1e-6));
      assert(closeTo(sc.linrand(9), 1.3636098378338, 1e-6));
      assert(closeTo(sc.linrand(9), 2.4977593284566, 1e-6));
  ...
  describe("rand(x)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.rand(1), 0.3682166337966, 1e-6));
      assert(closeTo(sc.rand(1), 0.7567865848541, 1e-6));
      assert(closeTo(sc.rand(1), 0.0821806192398, 1e-6));
      assert(closeTo(sc.rand(1), 0.2236770391464, 1e-6));
      assert(closeTo(sc.rand(9), 1.2253886461258, 1e-6));
      assert(closeTo(sc.rand(9), 6.0711017847061, 1e-6));
      assert(closeTo(sc.rand(9), 1.6433755159378, 1e-6));
      assert(closeTo(sc.rand(9), 6.6525800228119, 1e-6));
  ...
  describe("rand2(x)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.rand2(1), -0.2635667324066, 1e-6));
      assert(closeTo(sc.rand2(1), +0.5135731697082, 1e-6));
      assert(closeTo(sc.rand2(1), -0.8356387615203, 1e-6));
      assert(closeTo(sc.rand2(1), -0.5526459217071, 1e-6));
      assert(closeTo(sc.rand2(9), -6.5492227077484, 1e-4));
      assert(closeTo(sc.rand2(9), +3.1422035694122, 1e-4));
      assert(closeTo(sc.rand2(9), -5.7132489681244, 1e-4));
      assert(closeTo(sc.rand2(9), +4.3051600456238, 1e-4));
  ...
  describe("random()", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.random(), 0.3682166337966, 1e-6));
      assert(closeTo(sc.random(), 0.7567865848541, 1e-6));
      assert(closeTo(sc.random(), 0.0821806192398, 1e-6));
      assert(closeTo(sc.random(), 0.2236770391464, 1e-6));
  ...
  describe("rrand(a, b)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.rrand(1, 10), 4.3139497041702, 1e-6));
      assert(closeTo(sc.rrand(1, 10), 7.8110792636871, 1e-6));
      assert(closeTo(sc.rrand(1, 10), 1.7396255731583, 1e-6));
      assert(closeTo(sc.rrand(1, 10), 3.0130933523178, 1e-6));
      assert(closeTo(sc.rrand(9, 99), 21.253886461258, 1e-4));
      assert(closeTo(sc.rrand(9, 99), 69.711017847061, 1e-4));
      assert(closeTo(sc.rrand(9, 99), 25.433755159378, 1e-4));
      assert(closeTo(sc.rrand(9, 99), 75.525800228119, 1e-4));
  ...
  describe("sum3rand(x)", () => {
    it("works", () => {
      ...
      assert(closeTo(sc.sum3rand(1), -0.19521064212372, 1e-6));
      assert(closeTo(sc.sum3rand(1), -0.31040111773956, 1e-6));
      assert(closeTo(sc.sum3rand(1), -0.38400009790388, 1e-6));
      assert(closeTo(sc.sum3rand(1), +0.52686512170626, 1e-6));
      assert(closeTo(sc.sum3rand(9), -0.47941277153546, 1e-6));
      assert(closeTo(sc.sum3rand(9), -0.10134679549784, 1e-6));
      assert(closeTo(sc.sum3rand(9), -4.19061123370180, 1e-6));
      assert(closeTo(sc.sum3rand(9), +0.03040674237192, 1e-6));

      let randomAPI = randSeed([ 0.1, 0.6, 0.7, 0.4, 0.8 ]);

      assert(closeTo(sc.sum3rand(1, randomAPI), -0.06666666666666672, 1e-6));
      assert(closeTo(sc.sum3rand(1, randomAPI), -0.13333333333333314, 1e-6));
    });
  });
  describe("tan(x)", () => {
    it("works", () => {
